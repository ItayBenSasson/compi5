...
@.v_11 = private unnamed_addr constant [22 x i8] c"Not failing this time\00"
@.v_12 = private unnamed_addr constant [41 x i8] c"If you see this you if is in big trouble\00"
@.v_13 = private unnamed_addr constant [15 x i8] c"End of program\00"
define i32 @main() {
%var_0 = alloca i32
%var_1 = alloca i32
%var_2 = alloca i32
...
br label %label_6
label_6:
call void (i8*) @print(i8* getelementptr ([ 22 x i8], [22 x i8]* @.v_11, i32 0, i32 0))
br label %label_8
br label %label_7
label_7:
call void (i8*) @print(i8* getelementptr ([ 41 x i8], [41 x i8]* @.v_12, i32 0, i32 0))
br label %label_8
label_8:
